	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f9:	0f be 80 b1 22 80 00 	movsbl 0x8022b1(%eax),%eax
  800200:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002f5:	ff 24 85 00 24 80 00 	jmp    *0x802400(,%eax,4)
  ...
  8003b9:	8b 14 85 60 25 80 00 	mov    0x802560(,%eax,4),%edx
  8003c0:	85 d2                	test   %edx,%edx
  8003c2:	75 18                	jne    8003dc <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003c4:	50                   	push   %eax
  8003c5:	68 c9 22 80 00       	push   $0x8022c9
  8003ca:	53                   	push   %ebx
  8003cb:	56                   	push   %esi
  ...
  8003dc:	52                   	push   %edx
  8003dd:	68 95 26 80 00       	push   $0x802695
  8003e2:	53                   	push   %ebx
  8003e3:	56                   	push   %esi
  ...
  800401:	b8 c2 22 80 00       	mov    $0x8022c2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a7c:	68 bf 25 80 00       	push   $0x8025bf
  800a81:	6a 23                	push   $0x23
  800a83:	68 dc 25 80 00       	push   $0x8025dc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b3f:	68 bf 25 80 00       	push   $0x8025bf
  800b44:	6a 23                	push   $0x23
  800b46:	68 dc 25 80 00       	push   $0x8025dc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b81:	68 bf 25 80 00       	push   $0x8025bf
  800b86:	6a 23                	push   $0x23
  800b88:	68 dc 25 80 00       	push   $0x8025dc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bc3:	68 bf 25 80 00       	push   $0x8025bf
  800bc8:	6a 23                	push   $0x23
  800bca:	68 dc 25 80 00       	push   $0x8025dc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c05:	68 bf 25 80 00       	push   $0x8025bf
  800c0a:	6a 23                	push   $0x23
  800c0c:	68 dc 25 80 00       	push   $0x8025dc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c47:	68 bf 25 80 00       	push   $0x8025bf
  800c4c:	6a 23                	push   $0x23
  800c4e:	68 dc 25 80 00       	push   $0x8025dc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dd9:	ba 68 26 80 00       	mov    $0x802668,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e04:	51                   	push   %ecx
  800e05:	50                   	push   %eax
  800e06:	68 ec 25 80 00       	push   $0x8025ec
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80102e:	53                   	push   %ebx
  80102f:	50                   	push   %eax
  801030:	68 2d 26 80 00       	push   $0x80262d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801103:	53                   	push   %ebx
  801104:	50                   	push   %eax
  801105:	68 49 26 80 00       	push   $0x802649
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011b8:	53                   	push   %ebx
  8011b9:	50                   	push   %eax
  8011ba:	68 0c 26 80 00       	push   $0x80260c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80141f:	68 7c 26 80 00       	push   $0x80267c
  801424:	68 83 26 80 00       	push   $0x802683
  801429:	6a 7c                	push   $0x7c
  80142b:	68 98 26 80 00       	push   $0x802698
  801430:	e8 24 0a 00 00       	call   801e59 <_panic>
	assert(r <= PGSIZE);
  801435:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80143a:	7e 16                	jle    801452 <devfile_read+0x65>
  80143c:	68 a3 26 80 00       	push   $0x8026a3
  801441:	68 83 26 80 00       	push   $0x802683
  801446:	6a 7d                	push   $0x7d
  801448:	68 98 26 80 00       	push   $0x802698
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801519:	68 af 26 80 00       	push   $0x8026af
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8018bf:	68 bb 26 80 00       	push   $0x8026bb
  8018c4:	68 83 26 80 00       	push   $0x802683
  8018c9:	6a 62                	push   $0x62
  8018cb:	68 d0 26 80 00       	push   $0x8026d0
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80190c:	68 dc 26 80 00       	push   $0x8026dc
  801911:	68 83 26 80 00       	push   $0x802683
  801916:	6a 6d                	push   $0x6d
  801918:	68 d0 26 80 00       	push   $0x8026d0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801992:	68 e8 26 80 00       	push   $0x8026e8
  801997:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801a42:	50                   	push   %eax
  801a43:	56                   	push   %esi
  801a44:	68 ef 26 80 00       	push   $0x8026ef
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ce6:	68 07 27 80 00       	push   $0x802707
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e75:	56                   	push   %esi
  801e76:	50                   	push   %eax
  801e77:	68 14 27 80 00       	push   $0x802714
  ...
  801e88:	e8 6d e2 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  801e8d:	c7 04 24 00 27 80 00 	movl   $0x802700,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f2f:	50                   	push   %eax
  801f30:	68 38 27 80 00       	push   $0x802738
  801f35:	6a 4b                	push   $0x4b
  801f37:	68 50 27 80 00       	push   $0x802750
