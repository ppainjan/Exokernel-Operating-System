...
umain(int argc, char **argv)
{
  ...
  800040:	22 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 09 01 00 00       	call   800151 <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	68 6f 22 80 00       	push   $0x80226f
  80011e:	6a 23                	push   $0x23
  800120:	68 8c 22 80 00       	push   $0x80228c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019a:	68 6f 22 80 00       	push   $0x80226f
  80019f:	6a 23                	push   $0x23
  8001a1:	68 8c 22 80 00       	push   $0x80228c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001dc:	68 6f 22 80 00       	push   $0x80226f
  8001e1:	6a 23                	push   $0x23
  8001e3:	68 8c 22 80 00       	push   $0x80228c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021e:	68 6f 22 80 00       	push   $0x80226f
  800223:	6a 23                	push   $0x23
  800225:	68 8c 22 80 00       	push   $0x80228c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800260:	68 6f 22 80 00       	push   $0x80226f
  800265:	6a 23                	push   $0x23
  800267:	68 8c 22 80 00       	push   $0x80228c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a2:	68 6f 22 80 00       	push   $0x80226f
  8002a7:	6a 23                	push   $0x23
  8002a9:	68 8c 22 80 00       	push   $0x80228c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e4:	68 6f 22 80 00       	push   $0x80226f
  8002e9:	6a 23                	push   $0x23
  8002eb:	68 8c 22 80 00       	push   $0x80228c
...
sys_ipc_recv(void *dstva)
{
  ...
  800348:	68 6f 22 80 00       	push   $0x80226f
  80034d:	6a 23                	push   $0x23
  80034f:	68 8c 22 80 00       	push   $0x80228c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800476:	ba 18 23 80 00       	mov    $0x802318,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004a1:	51                   	push   %ecx
  8004a2:	50                   	push   %eax
  8004a3:	68 9c 22 80 00       	push   $0x80229c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006cb:	53                   	push   %ebx
  8006cc:	50                   	push   %eax
  8006cd:	68 dd 22 80 00       	push   $0x8022dd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007a0:	53                   	push   %ebx
  8007a1:	50                   	push   %eax
  8007a2:	68 f9 22 80 00       	push   $0x8022f9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800855:	53                   	push   %ebx
  800856:	50                   	push   %eax
  800857:	68 bc 22 80 00       	push   $0x8022bc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800abc:	68 2c 23 80 00       	push   $0x80232c
  800ac1:	68 33 23 80 00       	push   $0x802333
  800ac6:	6a 7c                	push   $0x7c
  800ac8:	68 48 23 80 00       	push   $0x802348
  800acd:	e8 24 0a 00 00       	call   8014f6 <_panic>
	assert(r <= PGSIZE);
  800ad2:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ad7:	7e 16                	jle    800aef <devfile_read+0x65>
  800ad9:	68 53 23 80 00       	push   $0x802353
  800ade:	68 33 23 80 00       	push   $0x802333
  800ae3:	6a 7d                	push   $0x7d
  800ae5:	68 48 23 80 00       	push   $0x802348
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bb6:	68 5f 23 80 00       	push   $0x80235f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f5c:	68 6b 23 80 00       	push   $0x80236b
  800f61:	68 33 23 80 00       	push   $0x802333
  800f66:	6a 62                	push   $0x62
  800f68:	68 80 23 80 00       	push   $0x802380
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800fa9:	68 8c 23 80 00       	push   $0x80238c
  800fae:	68 33 23 80 00       	push   $0x802333
  800fb3:	6a 6d                	push   $0x6d
  800fb5:	68 80 23 80 00       	push   $0x802380
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80102f:	68 98 23 80 00       	push   $0x802398
  801034:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8010df:	50                   	push   %eax
  8010e0:	56                   	push   %esi
  8010e1:	68 9f 23 80 00       	push   $0x80239f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801383:	68 b7 23 80 00       	push   $0x8023b7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801512:	56                   	push   %esi
  801513:	50                   	push   %eax
  801514:	68 c4 23 80 00       	push   $0x8023c4
  ...
  801525:	e8 54 00 00 00       	call   80157e <vcprintf>
	cprintf("\n");
  80152a:	c7 04 24 b0 23 80 00 	movl   $0x8023b0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80167d:	0f be 80 e7 23 80 00 	movsbl 0x8023e7(%eax),%eax
  801684:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801848:	50                   	push   %eax
  801849:	68 ff 23 80 00       	push   $0x8023ff
  80184e:	53                   	push   %ebx
  80184f:	56                   	push   %esi
  ...
  801860:	52                   	push   %edx
  801861:	68 45 23 80 00       	push   $0x802345
  801866:	53                   	push   %ebx
  801867:	56                   	push   %esi
  ...
  801885:	b8 f8 23 80 00       	mov    $0x8023f8,%eax
